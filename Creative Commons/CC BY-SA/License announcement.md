...
於下列條件的<span class="important_warning" style="color: red; font-weight: bold">限制</span>下您可以自由使用本作品之內容於任何用途：

* 姓名標示  
  <span class="important_warning" style="color: red; font-weight: bold">BY</span> as known as Attribution
	* 您必須**以本作品指定的方式**明確地標註本作品創作者的名稱「Ｖ字龍 &lt;<Vdragon.Taiwan@gmail.com>&gt;」於本作品之任何衍伸作品中（且不得以任何方式暗示本作品為您或您使用本作品的方式背書）。
* 相同方式分享  
  <span class="important_warning" style="color: red; font-weight: bold">S</span>hared <span class="important_warning" style="color: red; font-weight: bold">A</span>like
